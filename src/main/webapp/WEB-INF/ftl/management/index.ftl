...
<head>
    <meta charset="UTF-8">
    <title>CSBOOKS Management System</title>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <!--系统标题-->
        <div class="layui-logo" style="width:250px;font-size:16px">CSBOOKS Management System</div>
        <!--右侧当前用户信息-->
            ...
            <ul class="layui-nav layui-nav-tree">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child module" data-node-id="xxx">
                            ...
                            <dd><a href="/management/comments/index.html" target="ifmMain">短评管理
                                </a></dd>
                        </dl>
                    </li>
